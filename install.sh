...
echo 'function pcRmR()    { $MY_PYTHON $PYCOX_BASE/pycox.py --action rmr    --source "$1"; }'               >> setup.sh
echo 'function pcRmdir()  { $MY_PYTHON $PYCOX_BASE/pycox.py --action rmdir  --source "$1"; }'               >> setup.sh
echo 'function pcRmdirX() { $MY_PYTHON $PYCOX_BASE/pycox.py --action rmdirx --source "$1"; }'               >> setup.sh
